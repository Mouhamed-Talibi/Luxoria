        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-8 col-md-6">
                    <form action="{{ route('admin.store_product') }}" class="shadow p-3 mt-4" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="mb-4">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="price" class="form-control border-start-1 @error('price') is-invalid @enderror" 
                                            placeholder="Enter product price" value="{{ old('price') }}" step="0.5" min="1">
                                    </div>
                                    @error('price')
                                        <div class="text-danger mt-2 small">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-4">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="stock" class="form-control border-start-1 @error('stock') is-invalid @enderror" 
                                            placeholder="Enter product stock" value="{{ old('stock') }}" min="1">
                                    </div>
                                    @error('stock')
                                        <div class="text-danger mt-2 small">{{ $message }}</div>
                                    @enderror
