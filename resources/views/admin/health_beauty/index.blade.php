                ...
                <div class="text-center mt-5">
                    <div class="p-5 border rounded shadow-sm" style="max-width: 600px; margin: auto;">
                        <h1 class="mb-4" style="font-size: 2rem; color: #555;">
                            No Health & beauty products found
                        </h1>
                        <a href="{{ route('admin.health_beauty_products.create') }}" 
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('admin.health_beauty.edit', $product)}}" class="btn btn-outline-primary">
